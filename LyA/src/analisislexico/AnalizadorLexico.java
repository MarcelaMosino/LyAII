...
public class AnalizadorLexico {
    ...
    private int estado(String substring) {
        ...
        if(simbolo<=90 && simbolo>=65)        return 0; //Palabras reservadas
        else if(simbolo<=122 && simbolo>=97)  return 1; //Identificadores
        else if(simbolo<=57 && simbolo>=48)   return 3; //Numeros
        else                                  return 2;
    }   
